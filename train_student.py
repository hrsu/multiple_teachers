...
tf.flags.DEFINE_integer('teachers_max_steps', 1001,
                        'Number of steps teachers were ran.')
tf.flags.DEFINE_integer('max_steps', 1000, 'Number of steps to run student.')
...
def ensemble_preds(dataset, nb_teachers, stdnt_data):
  ...
  for teacher_id in xrange(nb_teachers):
    ...
    if FLAGS.deeper:
      ...
      #ckpt_path = FLAGS.teachers_dir + '/' + str(dataset) + '_' + str(nb_teachers) + '_teachers_' + str(teacher_id) + '_deep.ckpt-' + str(0) #NOLINT(long-line)
    else:
      ...
      #ckpt_path = FLAGS.teachers_dir + '/' + str(dataset) + '_' + str(nb_teachers) + '_teachers_' + str(teacher_id) + '.ckpt-' + str(0)  # NOLINT(long-line)
...
def train_student(dataset, nb_teachers):
  ...
  # Compute student label predic97tions on remaining chunk of test set
